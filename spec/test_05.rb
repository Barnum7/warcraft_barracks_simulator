...
# A unit is a common term in strategy games like Warcraft 3 and it stands for a soldier or person that performs a task of some
# kind. A footman is just one of many "units" that a barracks can train.
